  ...
  return (
    ...
    >
      ...
      <div className="waiting-title">
        Your creation is being listed with Art Plugged Network...
      </div>
...
const Congrats = (props: {
  ...
  const newTweetURL = () => {
    const params = {
      text: "I've created a new NFT auction on Art Plugged Network, check it out!",
      url: `${
        window.location.origin
      }/#/auction/${props.auction?.auction.toString()}`,
      hashtags: 'NFT,Crypto,ArtPluggedNetwork',
      // via: "Metaplex",
      related: 'ArtPluggedNetwork,Solana',
    };
